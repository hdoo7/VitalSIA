function FacsLib(engine) {
    ...
    this.ActionUnitsList = [
		...
		{ id : "1L"   , name : "innerBrowRaiserLeft"},
		{ id : "1R"   , name : "innerBrowRaiserRight"},		
		{ id : "2"   , name : "outerBrowRaiser"},
		{ id : "2L"  , name : "outerBrowRaiserLeft"},
		{ id : "2R"  , name : "outerBrowRaiserRight"},
		...
		{ id : "12L"  , name : "lipCornerPullerLeft"},
		{ id : "12R"  , name : "lipCornerPullerRight"},		
		{ id : "13"  , name : "sharpLipPuller"},
		{ id : "14"  , name : "dimpler"},
		{ id : "14L"  , name : "dimplerLeft"},
		{ id : "14R"  , name : "dimplerRight"},		
...
FacsLib.prototype = {
		...
		setLocalEyeTarget : function(
			xLeftEye,yLeftEye,zLeftEye, 
			xRightEye,yRightEye,zRightEye, 
			xHead,yHead,zHead, 
			eyesWeight, eyesSmoothTime, headWeight, headSmoothTime, debugVisible
		){
			engine.setLocalEyeTarget(
				xLeftEye,yLeftEye,zLeftEye, 
				xRightEye,yRightEye,zRightEye, 
				xHead,yHead,zHead, 
				eyesWeight, eyesSmoothTime, headWeight, headSmoothTime, debugVisible
