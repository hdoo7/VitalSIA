...
var ASM_CONSTS = {
  3097280: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3097341: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3097405: function() {return Module.webglContextAttributes.powerPreference;},  
 3097463: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3097518: function($0) {performance.now = function() { return $0; };},  
 3097566: function($0) {performance.now = function() { return $0; };},  
 3097614: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _PrintFrameJs(img, size, name) {
      var binary = '';
      
      for (var i = 0; i < size; i++)
        binary += String.fromCharCode(HEAPU8[img + i]);
      
      var filename = Pointer_stringify(name) + '.jpg';
