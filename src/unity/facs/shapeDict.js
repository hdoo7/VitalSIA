...
export const ActionUnitsList = [
    {
        ...
        muscularBasis: "frontalis (pars medialis)",
        links: [
    ...
    { id: "2R", name: "outerBrowRaiserR", faceSection: "Forehead" },
    {
        id: "4",
        name: "Brow Lowerer",
        muscularBasis: "depressor glabellae, depressor supercilii, corrugator supercilii",
        links: [
            "https://en.wikipedia.org/wiki/Depressor_glabellae",
    ...
    },
    {
        ...
        muscularBasis: "levator palpebrae superioris, superior tarsal muscle",
        links: [
    ...
    },
    {
        id: "25",
        name: "Lips Part",
        muscularBasis: "depressor labii inferioris, or relaxation of mentalis or orbicularis oris",
        links: [
            "https://en.wikipedia.org/wiki/Depressor_labii_inferioris",
    ...
    },
    {
        id: "26",
        name: "Jaw Drop",
        muscularBasis: "masseter; relaxed temporalis and internal pterygoid",
        links: [
    ...
    },
    {
        id: "27",
        name: "Mouth Stretch",
        muscularBasis: "pterygoids, digastric",
        links: [
    ...
    },
    {
        id: "31",
        name: "Jaw Clencher",
        muscularBasis: "masseter, temporalis",
        links: [
            "https://en.wikipedia.org/wiki/Masseter",
            "https://en.wikipedia.org/wiki/Temporalis"
        ],
